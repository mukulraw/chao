package app.in.chaiwale.PaytmPack;
...
public class PaytmWallet {
    ...
    public PaytmWallet(String mId, String channelId, String txnAmount, String website, String callBackUrl, String industryTypeId) {
        this.mId = mId;
          this.orderId = generateString();
       // this.orderId = String.valueOf(Proceed_order.order_id);
